  ...
  return (
    <div className="w-full">
      {label && (
        <label 
          htmlFor={inputId}
          className="block text-sm font-medium text-automotive-700 dark:text-automotive-300 mb-2"
        >
          {label}
        </label>
      )}
      <div className="relative">
        ...
        <input
          ...
          className={`w-full px-4 py-2.5 ${Icon ? 'pl-10' : ''} 
            bg-white dark:bg-automotive-700 
            border border-automotive-300 dark:border-automotive-600 
            rounded-lg 
            text-automotive-900 dark:text-white 
            placeholder-automotive-400 
